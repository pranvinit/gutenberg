...
-   Route HEIC/HEIF uploads by file content in HEIC-only processing mode, so images with a mismatched extension are converted instead of being passed to the server unchanged ([#81707](https://github.com/WordPress/gutenberg/issues/81707)).
